...
var api = [
  ...
  ['DELETE', '/applications/:client_id/tokens/:access_token', '/applications/610/tokens/5678tokens'],
  ...
  ['GET', '/repos/:owner/:repo/notifications', '/repos/trekjs/trek/notifications'],
  ['PUT', '/notifications', '/notifications'],
  ['PUT', '/repos/:owner/:repo/notifications', '/repos/trekjs/router/notifications'],
  ...
  ['GET', '/repos/:owner/:repo/subscribers', '/repos/trekjs/router/subscribers'],
  ['GET', '/users/:user/subscriptions', '/users/fundon/subscriptions'],
  ['GET', '/user/subscriptions', '/user/subscriptions'],
  ['GET', '/repos/:owner/:repo/subscription', '/repos/trekjs/router-mapper/subscription'],
  ['PUT', '/repos/:owner/:repo/subscription', '/repos/trekjs/router-mapper/subscription'],
  ['DELETE', '/repos/:owner/:repo/subscription', '/repos/trekjs/router-mapper/subscription'],
  ['GET', '/user/subscriptions/:owner/:repo', '/user/subscriptions/trekjs/trek'],
  ['PUT', '/user/subscriptions/:owner/:repo', '/user/subscriptions/trekjs/trek'],
  ['DELETE', '/user/subscriptions/:owner/:repo', '/user/subscriptions/trekjs/trek'],
  ...
  // Git Data
  ['GET', '/repos/:owner/:repo/git/blobs/:sha', '/repos/trekjs/trek/git/blobs/abcdefgh'],
  ['POST', '/repos/:owner/:repo/git/blobs', '/repos/trekjs/trek/git/blobs'],
  ['GET', '/repos/:owner/:repo/git/commits/:sha', '/repos/trekjs/trek/git/commits/abcdefgh'],
  ...
  ['GET', '/repos/:owner/:repo/git/tags/:sha', '/repos/trekjs/trek/git/tags/233'],
  ['POST', '/repos/:owner/:repo/git/tags', '/repos/trekjs/trek/git/tags'],
  ['GET', '/repos/:owner/:repo/git/trees/:sha', '/repos/trekjs/trek/git/trees/377'],
  ...
  ['GET', '/repos/:owner/:repo/issues/:number', '/repos/trekjs/trek/issues/377'],
  ...
  ['POST', '/repos/:owner/:repo/issues/:number/comments', '/repos/trekjs/trek/issues/377/comments'],
  //['PATCH', '/repos/:owner/:repo/issues/comments/:id'],
  //['DELETE', '/repos/:owner/:repo/issues/comments/:id'],
  ['GET', '/repos/:owner/:repo/issues/:number/events', '/repos/trekjs/trek/issues/233/events'],
  ...
  ['GET', '/repos/:owner/:repo/milestones/:number', '/repos/trekjs/trek/milestones/1024'],
  ['POST', '/repos/:owner/:repo/milestones', '/repos/trekjs/trek/milestones'],
  //['PATCH', '/repos/:owner/:repo/milestones/:number'],
  ['DELETE', '/repos/:owner/:repo/milestones/:number', '/repos/trekjs/trek/milestones/233'],
  ...
  ['GET', '/orgs/:org/public_members/:user', '/orgs/trekjs/public_members/fundon'],
  ['PUT', '/orgs/:org/public_members/:user', '/orgs/trekjs/public_members/fundon'],
  ['DELETE', '/orgs/:org/public_members/:user', '/orgs/trekjs/public_members/fundon'],
  ...
  ['GET', '/repos/:owner/:repo/pulls/:number/commits', '/repos/trekjs/trek/pulls/233/commits'],
  ['GET', '/repos/:owner/:repo/pulls/:number/files', '/repos/trekjs/trek/pulls/233/files'],
  ['GET', '/repos/:owner/:repo/pulls/:number/merge', '/repos/trekjs/trek/pulls/233/merge'],
  ['PUT', '/repos/:owner/:repo/pulls/:number/merge', '/repos/trekjs/trek/pulls/233/merge'],
  ['GET', '/repos/:owner/:repo/pulls/:number/comments', '/repos/trekjs/trek/pulls/233/comments'],
  //['GET', '/repos/:owner/:repo/pulls/comments'],
  //['GET', '/repos/:owner/:repo/pulls/comments/:number'],
  ['PUT', '/repos/:owner/:repo/pulls/:number/comments', '/repos/trekjs/trek/pulls/233/comments'],
  ...
  ['GET', '/repos/:owner/:repo/contributors', '/repos/trekjs/trek/contributors'],
  ...
  ['GET', '/repos/:owner/:repo/branches/:branch', '/repos/trekjs/trek/branches/master'],
  ['DELETE', '/repos/:owner/:repo', '/repos/trekjs/trek'],
  ['GET', '/repos/:owner/:repo/collaborators', '/repos/trekjs/trek/collaborators'],
  ['GET', '/repos/:owner/:repo/collaborators/:user', '/repos/trekjs/trek/collaborators/fundon'],
  ['PUT', '/repos/:owner/:repo/collaborators/:user', '/repos/trekjs/trek/collaborators/fundon'],
  ['DELETE', '/repos/:owner/:repo/collaborators/:user', '/repos/trekjs/trek/collaborators/fundon'],
  ['GET', '/repos/:owner/:repo/comments', '/repos/trekjs/trek/comments'],
  ['GET', '/repos/:owner/:repo/commits/:sha/comments', '/repos/trekjs/trek/commits/abcdefgh/comments'],
  ['POST', '/repos/:owner/:repo/commits/:sha/comments', '/repos/trekjs/trek/commits/abcdefgh/comments'],
  ['GET', '/repos/:owner/:repo/comments/:id', '/repos/trekjs/trek/comments/1024'],
  //['PATCH', '/repos/:owner/:repo/comments/:id'],
  ['DELETE', '/repos/:owner/:repo/comments/:id', '/repos/trekjs/trek/comments/1024'],
  ['GET', '/repos/:owner/:repo/commits', '/repos/trekjs/trek/commits'],
  ['GET', '/repos/:owner/:repo/commits/:sha', '/repos/trekjs/trekj/commits/abcdefgh'],
  ...
  ['GET', '/repos/:owner/:repo/downloads/:id', '/repos/trekjs/trek/downloads/233'],
  ['DELETE', '/repos/:owner/:repo/downloads/:id', '/repos/trekjs/trek/downloads/987'],
  ...
  ['POST', '/repos/:owner/:repo/hooks/:id/tests', '/repos/trekjs/trek/hooks/231/tests'],
  ...
  ['GET', '/repos/:owner/:repo/releases/:id', '/repos/trekjs/trek/releases/233'],
  ['POST', '/repos/:owner/:repo/releases', '/repos/trejs/trek/releases'],
  //['PATCH', '/repos/:owner/:repo/releases/:id'],
  ['DELETE', '/repos/:owner/:repo/releases/:id', '/repos/trekjs/trek/releases/231'],
  ['GET', '/repos/:owner/:repo/releases/:id/assets', '/repos/trekjs/trek/releases/233/assets'],
  ['GET', '/repos/:owner/:repo/stats/contributors', '/repos/trekjs/trek/stats/contributors'],
  ['GET', '/repos/:owner/:repo/stats/commit_activity', '/repos/trejs/trek/stats/commit_activity'],
  ['GET', '/repos/:owner/:repo/stats/code_frequency', '/repos/trekjs/trek/stats/code_frequency'],
  ['GET', '/repos/:owner/:repo/stats/participation', '/repos/trekjs/trek/stats/participation'],
  ['GET', '/repos/:owner/:repo/stats/punch_card', '/repos/trekjs/trek/stats/punch_card'],
  ['GET', '/repos/:owner/:repo/statuses/:ref', '/repos/trekjs/trek/statuses/dev'],
  ['POST', '/repos/:owner/:repo/statuses/:ref', '/repos/trekjs/trek/statuses/master'],
